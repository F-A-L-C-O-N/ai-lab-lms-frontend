          ...
          <div className="col-span-1 md:col-span-7 p-8 sm:p-10 flex flex-col justify-center">
            <AnimatePresence mode="wait">
              {!signUpSuccess ? (
                ...
                <motion.div key="signup-success" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.4 }} className="flex flex-col items-center justify-center py-16 text-center relative overflow-hidden">
