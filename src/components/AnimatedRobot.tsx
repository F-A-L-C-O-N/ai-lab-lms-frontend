...
export default function AnimatedRobot() {
  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex items-end gap-2.5 sm:gap-4 pointer-events-none">
      {/* Robot Button */}
      <motion.div
        layout
        className="pointer-events-auto flex flex-col items-center cursor-pointer select-none flex-shrink-0"
          ...
          >
            ...
            <div className="relative z-10 px-4 py-3.5 sm:px-6 sm:py-5 flex items-center justify-between border-b border-slate-100/80 dark:border-slate-800/60" style={{
              ...
              <div className="flex items-center gap-2.5 sm:gap-3">
                ...
                <div>
                  <h3 className="text-slate-800 dark:text-slate-100 font-extrabold text-xs sm:text-sm tracking-tight flex items-center gap-1">
                    AI Lab Assistant
                ...
                >
                  <div className={`flex items-start gap-2 max-w-[85%] ${msg.role === 'user' ? 'flex-row-reverse' : ''}`}>
                    ...
                    <div className={`px-4 py-3 rounded-[20px] text-xs sm:text-[13px] leading-relaxed shadow-sm whitespace-pre-wrap transition-all ${
                      msg.role === 'user'
                        ? 'bg-gradient-to-r from-indigo-500 to-indigo-600 text-white rounded-tr-sm shadow-[0_4px_12px_rgba(99,102,241,0.2)]'
                ...
                {isTyping && (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <span className="text-[10px] sm:text-xs text-indigo-600 dark:text-indigo-400 font-extrabold uppercase tracking-wider animate-pulse flex items-center gap-1">
